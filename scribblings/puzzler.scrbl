...
@title{Puzzler: A Language for 2D Puzzle Game Creation}
...
@subsection{The Goal Map Section}
...
@subsection{The Interaction Section}
...
@subsection{Wrapping Up: A Finished Game}
